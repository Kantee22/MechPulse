...
export default function Architecture() {
  return (
    <div className="liquid-page-flow">
      <LiquidHero kicker="Pipeline · Node-RED · FastAPI · React" title="System architecture">
      ...
      <LiquidSection kicker="Diagram" title="Data flow" subtitle="SVG overview">
        <ArchitectureDiagram />
      </LiquidSection>

      <LiquidDivider />

      <LiquidSection kicker="Sources & stack" title="Building blocks" subtitle="Reference">
      ...
      <LiquidSection kicker="API" title="What the backend exposes" subtitle="Summary">
        <div className="card">
